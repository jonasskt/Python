...
class MainApp(App):
    ...
    def on_button_press(self, instance):
        ...
        if button_text =='C':
            ...
            if current and(
                self.last_operadores and button_text in self.operadores
            ):
                return
            elif current == '' and button_text in self.operadores:
                return
            else: 
        ...
        self.last_operadores= self.ultimo_botao in self.operadores
